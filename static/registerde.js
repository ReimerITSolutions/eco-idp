$(function(){
  ...
  app.tooltip = $("#pwlabel").kendoTooltip({
    ...
    position: "bottom",
    callout:true,
    content: 'Ihr Kennwort sollte die folgenden Kriterien erfüllen:<ul><li>Das Kennwort muss mindestens 8 Zeichen umfassen</li><li>davon mindestens 1 Nummer</li><li>davon mindestens 1 Großbuchstaben </li><li>darf nicht gleich Ihrer zugehörigen E-mail Adresse sein</li></ul>',
  }).data("kendoTooltip");
